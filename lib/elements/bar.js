...
import { DrawXYAxis } from '../utils/applicationUtils';
        ...
        return (
            <View style={[{ alignItems: 'center' }, this.props.style]}>
                <Svg width={this.state.svgWidth} height={this.state.svgHeight}>
                    {DrawXYAxis(this.state.svgHeight - 30, this.props.yMax, this.state.svgWidth - 50, 5)}
                    {this.renderBarItem(this.state.svgHeight, this.props.Data, this.props.animateRow)}
                </Svg>
            </View>
        )
    }
