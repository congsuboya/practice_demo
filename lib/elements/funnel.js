...
export default class Funnel extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            viewHeight,
            viewWidth,
            perHeight: (viewHeight - 20) / props.option.series[0].data.length,
            funnelData: funnelData,
            interNum: props.option.series[0].data.length,
            ...props.option
        }
    ...
    clickItemView(location) {
        let { perHeight, funnelData } = this.state;
        ...
        // alert(parseInt(nativeEvent.locationY / perHeight));
    }
